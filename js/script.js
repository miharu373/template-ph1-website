...
/*let element = document.getElementById('js-quiz');
element.insertAdjacentHTML('beforeend', '<section class="p-quiz-box js-quiz" data-quiz="1">
<div class="p-quiz-box__question">
    <h2 class="p-quiz-box___question__title">
        <span class="p-quiz-box__label">02</span>
...
<div class="p-quiz-box__answer">
    ...
    <ul class="p-quiz-box__answer__list">
        <li class="p-quiz-box__answer__item">
            <button class="p-quiz-box__answer__button js-answer" data-answer="0">INTECH<i class="u-icon__arrow"></i></button>
        </li>
        <li class="p-quiz-box__answer__item">
            <button class="p-quiz-box__answer__button js-answer" data-answer="1">BIZZTECH<i class="u-icon__arrow"></i></button>
        </li>
        <li class="p-quiz-box__answer__item">
            <button class="p-quiz-box__answer__button js-answer" data-answer="2">X-TECH<i class="u-icon__arrow"></i></button>
        </li>
    </ul>
    <div class="p-quiz-box__answer__correct js-answerBox">
        <p class="p-quiz-box__answer__correct__title js-answerTitle"></p>
...
/*let allQuiz = getElementById('allQuiz');
let add_code= id: 5,
question: 'イギリスのコンピューター科学者であるギャビン・ウッド氏が提唱した、ブロックチェーン技術を活用した「次世代分散型インターネット」のことをなんと言うでしょう？',
answers: ['Web3.0', 'NFT', 'メタバース'],
correctNumber: 0,*/
